...
**280+ million immigrants worldwide face the same nightmare**: Immigration law is locked behind three impenetrable barriers.

### **Barrier 1: Expertise**
Immigration law requires specialized lawyers. A typical immigration case costs **$1,500–$5,000+** in legal fees—unaffordable for most migrants.

### **Barrier 2: Cost**
Legal fees consume relocation budgets. Without a lawyer, immigrants make costly mistakes: missing deadlines, submitting wrong documents, or following outdated processes.

### **Barrier 3: Language & Accessibility**
Resources exist in English, Spanish, French—but 280+ million immigrants speak 200+ languages. An Arabic speaker seeking a UK visa. A Portuguese speaker in Germany. A Tamil speaker in Canada. They're stuck.

---

## ✅ How FreePath Breaks These Barriers

| Barrier | Traditional Solution | FreePath |
|---------|----------------------|----------|
| **Expertise** | Pay lawyers $1-5K+ | AI understands ALL immigration law |
| **Cost** | Afford legal fees or fail | Completely FREE |
| **Language** | Find resources in your language | Portuguese • English • Arabic (+ more coming) |
| **Personalization** | Generic website advice | Adapts to YOUR nationality, origin, destination, visa type |
...
FreePath uses **Claude Opus 4.6** to break the expertise barrier—without needing 3 years of law school.

### **1. Ingesting Entire Legislation Corpus**
Traditional AI suffers from "context rot": too many documents = degraded reasoning. **Opus 4.6's 1M token context** (beta) solves this.
...
Opus 4.6 dynamically decides *how much to think* based on your case complexity.

- **Simple visa question?** → ⚡ Fast answer (minimal thinking)
- **Complex asylum case with 5 nationality claims?** → 🧠 Deep reasoning, multi-step analysis
- Users see the thinking process in real-time, building trust

### **3. Four Specialized AI Agents Working in Parallel**

FreePath deploys **4 expert agents** to break down immigration into manageable parts:
...
Each agent has its own specialized prompt and reasoning style. They work **in parallel** and combine insights into a single actionable guide.
...
**The result**: Customized pathway + document checklist + timeline + next steps—all in your language.

---

## ⚡ Key Features

- **Smart Form Filling** — AI pre-fills government forms based on your context
- **Dynamic Checklists** — Generates exact documents needed + tracking
- **Timeline Estimation** — Processing times, appointment scheduling, next milestones
- **Multi-Language Support** — Portuguese, English, Arabic with RTL (right-to-left) support
- **Real-Time Progress** — Watch agents work, see token usage, visible thinking blocks
- **No Legal License Needed** — Guidance is educational, not legal advice
- **Fully Open Source** — MIT licensed, completely transparent, run it yourself
...
|-----------|-----------|------|
| **Backend** | Rails 8 + PostgreSQL + Redis | Rapid API development, strong conventions, production-ready |
| **Frontend** | React 19 + Tailwind CSS + Vite | Responsive real-time UI, modern tooling, fast dev experience |
| **AI** | Claude Opus 4.6 with Adaptive Thinking | Legal domain reasoning at scale, 1M context, agentic capabilities |
| **Real-Time** | Action Cable + Server-Sent Events | WebSocket stability, progressive streaming, no polling |
...
- ✅ Multi-language support (Portuguese, English, Arabic)
...
- **Components**: 30+ React components (chat, progress boxes, agent cards, thinking blocks)
...
- **Agents**: Base class + 4 specialists (Pathway Strategist, Eligibility Analyst, Documentation Specialist, Application Manager)
- **Legislation Crawler**: Streaming service with progressive database saves
- **SSE Streaming**: Real-time updates to frontend
- **Database**: Countries + Legislations (with versioning & deprecation tracking)
...
This project is 100% open source. Everything is published under the MIT license:
- ✅ Backend code
- ✅ Frontend code
- ✅ Database schemas
- ✅ Agent prompts
...
**Contribution guidelines**: See [.claude/docs/git-conventions.md](./.claude/docs/git-conventions.md)

**Report issues**: [GitHub Issues](<repository>/issues)
...
**Status quo**: Only wealthy immigrants can afford lawyers. Poor immigrants make mistakes.

**FreePath's change**: Remove cost barriers. Remove expertise barriers. Remove language barriers.
...
- 🤝 **Optional lawyer marketplace** — human expertise available (but not required)

### The Bigger Picture
Immigration shapes lives. Careers. Families. Safety. Yet most immigrants navigate bureaucratic systems alone, scared, unsure.
...
- **Track**: "Break the Barriers" — Take expert knowledge locked behind expertise, cost, or language barriers and put it in everyone's hands
- **Dates**: Feb 15-18, 2026
- **Judging**: Asynchronous (Feb 16-17) + Live final round (Feb 18, 12PM EST)
- **Judging Criteria**: Impact (25%) • Opus 4.6 Use (25%) • Depth & Execution (20%) • Demo (30%)
...
- [.claude/docs/git-conventions.md](./.claude/docs/git-conventions.md) — Git commit standards
- [.claude/docs/clean-code.md](./.claude/docs/clean-code.md) — Code style guide
- [.claude/docs/design-system.md](./.claude/docs/design-system.md) — Design tokens & RTL rules
- [frontend/src/lib/i18n-glossary.md](./frontend/src/lib/i18n-glossary.md) — Translation glossary
