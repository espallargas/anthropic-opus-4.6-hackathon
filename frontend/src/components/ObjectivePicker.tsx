    ...
    <div className="flex flex-col gap-4">
      ...
      {isOtherSelected && (
        <input
          ...
          autoFocus
          className="w-full rounded-lg border border-white/10 bg-white/5 px-4 py-2.5 text-sm text-white placeholder-white/40 outline-none transition-colors focus:border-white/25 focus:bg-white/8"
        />
      )}
    </div>
  )
