export const countryCentroids: Record<string, { lat: number; lng: number; name: string }> = {
  ...
  CG: { lat: -4.0, lng: 21.8, name: 'Republic of the Congo' },
  ...
  CV: { lat: 16.1, lng: -23.6, name: 'Cabo Verde' },
...
export function getCountryPreposition(code: string, locale: string): string {
